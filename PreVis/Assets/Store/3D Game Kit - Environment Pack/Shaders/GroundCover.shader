...
Shader "Custom/GroundCover" {
	...
	SubShader {
		...
		void vert (inout appdata_full v, out Input o) {
        	...
        	v.vertex.z += sin(_Time*20 + worldPos.z) * v.color.a * _NoiseAmount.z * v.color.r * windNoise.g;
        	v.vertex.z += sin(_Time*15 + worldPos.z) * v.color.a * _NoiseAmount.z * v.color.g * windNoise.g;
        	v.vertex.z += sin(_Time*25 + worldPos.z) * v.color.a * _NoiseAmount.z * v.color.b * windNoise.g;

        	v.vertex.x += sin(_Time*20 + worldPos.x) * v.color.a * _NoiseAmount.x * v.color.r * windNoise.r;
        	v.vertex.x += sin(_Time*15 + worldPos.x) * v.color.a * _NoiseAmount.x * v.color.g * windNoise.r;
        	v.vertex.x += sin(_Time*25 + worldPos.x) * v.color.a * _NoiseAmount.x * v.color.b * windNoise.r;
